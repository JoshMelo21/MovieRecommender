...
with open('tmdb_5000_movies.csv', encoding="utf8") as csv_file:
    ...
    for col in csv_reader:
        if line_count == 0:
            ...
            if float(col[18]) < 6 or float(col[8]) < 20: #Checking to see if a movie has certain voter score and ranking
...
runtime = input('Do you like Long Movies. Type long or short (approx. 2 > hr): ')
#runtime = "long"

keywords = input('Enter Some Keywords that may help with the Recommendations: ')
